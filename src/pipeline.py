...
def analyze_squat_video(path, draw=False, save_debug=False, debug_path="results/squat_debug.mp4"):
...
def main():
    parser = argparse.ArgumentParser(description="Squat form analyzer")
